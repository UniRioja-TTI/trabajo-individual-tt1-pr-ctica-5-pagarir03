...
public class SolicitudController {
	...
	public SolicitudController(InterfazContactoSim ics, Logger logger, ConsumidorApi consumidor) {
	    this.ics = ics;
	    this.logger = logger;
    ...
    @GetMapping("/grid")
    public String mostrarGrid(@RequestParam String tok, Model model) {
        logger.info("Accediendo al grid con token: " + tok);
        
        String datosMv = consumidor.obtenerDatosGrid(tok);
        System.out.println(">>> RESPUESTA DE LA MV: " + datosMv);
        
        model.addAttribute("resultado", datosMv);
